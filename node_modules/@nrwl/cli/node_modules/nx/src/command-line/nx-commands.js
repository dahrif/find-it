...
exports.commandsObject = yargs
    ...
    builder: (yargs) => linkToNxDevAndExamples(withRunManyOptions(withOutputStyleOption(withParallelOption(withTargetOption(yargs)))), 'run-many'),
    ...
    builder: (yargs) => linkToNxDevAndExamples(withAffectedOptions(withOutputStyleOption(withParallelOption(withTargetOption(yargs)))), 'affected'),
    ...
    describe: false,
    builder: (yargs) => linkToNxDevAndExamples(withAffectedOptions(withOutputStyleOption(withParallelOption(yargs))), 'affected'),
    handler: (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
- Run migrations (e.g., nx migrate --run-migrations=migrations.json)`,
    ...
    handler: () => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => require('./init'))).initHandler(); }),
})
    .command({
    command: 'list [plugin]',
    ...
    handler: (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        args._ = args._.slice(1);
        process.exit(yield (yield Promise.resolve().then(() => require('./generate'))).newWorkspace(args['nxWorkspaceRoot'], args));
    }),
})
    .command('_migrate [packageAndVersion]', false, (yargs) => withMigrationOptions(yargs), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
function withOutputStyleOption(yargs) {
