...
function affected(command, parsedArgs, extraTargetDependencies = {}) {
            ...
            switch (command) {
                    ...
                    if (parsedArgs.plain) {
                        ...
                        if (apps.length) {
                            output_1.output.warn({
                                title: 'Deprecated: Use "nx print-affected --type=app --select=projects" instead. This command will be removed in v15.',
                            });
                            output_1.output.log({
                                title: 'Affected apps:',
                ...
                case 'libs':
                    ...
                    if (parsedArgs.plain) {
                        ...
                        if (libs.length) {
                            output_1.output.warn({
                                title: 'Deprecated: Use "nx print-affected --type=lib --select=projects" instead. This command will be removed in v15.',
                            });
                            output_1.output.log({
                                title: 'Affected libs:',
                ...
                case 'affected': {
                    const projectsWithTarget = allProjectsWithTarget(projects, nxArgs);
                    yield (0, run_command_1.runCommand)(projectsWithTarget, projectGraph, env, nxArgs, overrides, null, extraTargetDependencies);
                    break;
                }
            }
        }
