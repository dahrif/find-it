...
function runMany(parsedArgs, extraTargetDependencies = {}) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        perf_hooks_1.performance.mark('command-execution-begins');
        const env = (0, read_environment_1.readEnvironment)();
        const { nxArgs, overrides } = (0, command_line_utils_1.splitArgsIntoNxArgsAndOverrides)(parsedArgs, 'run-many', { printWarnings: true }, env.nxJson);
        ...
        yield (0, run_command_1.runCommand)(projects, projectGraph, env, nxArgs, overrides, null, extraTargetDependencies);
    });
}
