        ...
        const renderProjectRows = () => {
            ...
            if (runningTasks.length > 0) {
                ...
                for (const projectRow of runningTasks) {
                    additionalFooterRows.push(`   ${output_1.output.dim.cyan(cli_spinners_1.dots.frames[projectRowsCurrentFrame])}    ${output_1.output.formatCommand(projectRow.projectName + ':' + targetName)}`);
                }
                /**
