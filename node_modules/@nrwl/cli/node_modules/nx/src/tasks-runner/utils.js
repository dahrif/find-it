...
function getOutputsForTargetAndConfiguration(task, node) {
    ...
    if (targets === null || targets === void 0 ? void 0 : targets.outputs) {
        return targets.outputs
            ...
            return (0, fileutils_1.isRelativePath)(interpolated)
                ? (0, path_2.joinPathFragments)(node.data.root, interpolated)
                : interpolated;
        })
