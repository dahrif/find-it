...
exports.API_LEVEL_32 = Object.freeze({
    apiLevel: '32',
    validate: (packages) => {
        const schemas = [
    ...
    loadPartialAVDSchematic: async () => Promise.resolve().then(() => require('../../data/avds/Pixel_3_API_32.json')),
});
